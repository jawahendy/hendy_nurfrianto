...
const Desktop = () => {
    return (
        <div className="hidden sm:grid grid-cols-7 grid-rows-7 gap-3 p-10 flex-1 max-w-screen-2xl h-full min-h-screen">
            <div className="col-span-4 row-span-2 col-start-2 row-start-1 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex flex-col items-start justify-center px-8">
            ...
            <div className="row-span-2 col-start-1 row-start-1 bg-slate-600 rounded-2xl relative overflow-hidden bg-white/20 backdrop-blur-md border border-white/30">
            ...
            <div className="col-span-4 row-span-2 col-start-1 row-start-3 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex flex-col justify-center px-8">
                {/* Arrow Up Right Icon */}
            ...
            <div className="col-start-6 row-start-1 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center relative">
                {/* Arrow Up Right Icon */}
                <span className="absolute top-1 right-1 bg-white/30 backdrop-blur-md rounded-full p-1 flex items-center justify-center">
                    <ArrowUpRight className='w-4 h-4 text-white' />
                </span>
            ...
            <div className="col-start-7 row-start-1 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center">
                <span className="absolute top-1 right-1 bg-white/30 backdrop-blur-md rounded-full p-1 flex items-center justify-center">
                    <ArrowUpRight className='w-4 h-4 text-white' />
                </span>
                {/* LinkedIn Icon */}
            ...
            <div className="col-start-7 row-start-2 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center relative">
                <span className="absolute top-1 right-1 bg-white/30 backdrop-blur-md rounded-full p-1 flex items-center justify-center">
                    <ArrowUpRight className='w-4 h-4 text-white' />
                </span>
                {/* Instagram Icon */}
            ...
            <div className="col-start-6 row-start-2 bg-slate-600 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center relative">
                <span className="absolute top-1 right-1 bg-white/30 backdrop-blur-md rounded-full p-1 flex items-center justify-center">
                    <ArrowUpRight className='w-4 h-4 text-white' />
                </span>
                {/* YouTube Icon */}
            ...
            <div className="row-span-2 col-start-5 row-start-3 bg-slate-600 rounded-2xl  relative overflow-hidden bg-white/20 backdrop-blur-md border border-white/30">
            ...
            <div className="row-span-2 col-start-6 row-start-3 bg-slate-600 rounded-2xl  relative overflow-hidden bg-white/20 backdrop-blur-md border border-white/30">
            ...
            <div className="row-span-2 col-start-7 row-start-3 rounded-2xl relative overflow-hidden border border-white/30">
